...
/**
  ...
  */
object SplashDemoApp extends JFXApp {

  val ApplicationIcon = "http://cdn1.iconfinder.com/data/icons/Copenhagen/PNG/32/people.png"

  val friendTask = new jfxr.Task[jfxc.ObservableList[String]]() {
  ...
  // Show splash stage
  Splash.show(new JFXApp.PrimaryStage(), friendTask, () => showMainStage(friendTask.value))
